...
echo '  scope_id: "'$SCOPE_ID'"' >> $FILE_NAME
echo '' >> $FILE_NAME
echo '  attestation:' >> $FILE_NAME
echo '    method: "symmetric_key"' >> $FILE_NAME
echo '    registration_id: "'$REGISTRATION_ID'"' >> $FILE_NAME
echo '' >> $FILE_NAME
echo '    symmetric_key: "'$SYMMETRIC_KEY'"' >> $FILE_NAME
echo '' >> $FILE_NAME
echo '  always_reprovision_on_startup: true' >> $FILE_NAME
echo '  dynamic_reprovisioning: false' >> $FILE_NAME
echo '' >> $FILE_NAME
